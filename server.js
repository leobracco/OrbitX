...
const ROL_LABELS = {
  superadmin:"Super Admin", owner:"Dueño", admin_org:"Admin",
  agronomo:"Agrónomo", contratista:"Contratista", operador:"Operador",
  viewer:"Viewer", user:"Usuario"
};
const ROL_COLORS = {
  superadmin:"#B8FF3C", owner:"#3C9EFF", admin_org:"#3CFFCF",
  agronomo:"#A78BFA", contratista:"#FFB03C", operador:"#FB923C",
  viewer:"#94A3B8", user:"#94A3B8"
};
